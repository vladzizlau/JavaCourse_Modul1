...
<link href="style/InfoDelivery.css" rel="stylesheet">
</head>
<body>
<div id="container">
...
<span style="color:#000000;font-family:Arial;font-size:24px;"><strong>Доставка<br></strong></span><span style="color:#000000;font-family:Arial;font-size:16px;"><br>В нашем интернет-магазине продаются только цифровые товары.<br><br>Мы не осуществляем доставку приобретенных вами цифровых-товаров на физических носителях информации. <br><br>Приобретенные товары вы скачиваете по ссылке, которая становится доступной в личном кабинете в разделе «Мои цифровые товары» после оплаты заказа.</span></div>
</form>
</div>
</div>
</body>
