...
<a id="Button1" href="addprod.jsp" style="position:absolute;left:-150px;top:0px;width:148px;height:41px;z-index:18;">Добавить</a>
<a id="Button1" href="editprod.jsp" style="position:absolute;left:-150px;top:50px;width:148px;height:41px;z-index:18;">Редактировать</a>
<a id="Button1" href="deleteprod.jsp" style="position:absolute;left:-150px;top:100px;width:148px;height:41px;z-index:18;">Удалить</a>
