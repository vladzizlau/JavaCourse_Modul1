...
<div id="wb_password" style="position:absolute;left:90px;top:128px;width:44px;height:14px;z-index:16;">
<span style="color:#000000;font-family:Arial;font-size:15px;">Email:</span></div>
<div id="wb_Text4" style="position:absolute;left:97px;top:220px;width:33px;height:14px;z-index:12;">
<span style="color:#000000;font-family:Arial;font-size:15px;">Имя:</span></div>
<div id="wb_Text5" style="position:absolute;left:64px;top:251px;width:67px;height:14px;z-index:13;">
